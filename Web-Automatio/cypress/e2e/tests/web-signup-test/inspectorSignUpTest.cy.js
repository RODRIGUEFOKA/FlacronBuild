...
const ProfileObj = new inspectorProfilePage()
    ...
    cy.wrap(email).as('savedEmail')
      ...
      signupObj.enterPassword(faker.internet.password({ length: 6 }))
       ...
       //validation
         ...
         // Plan selection
    const selectedPlan = 'Inspector';  // Can be changed to any card and use same name
   ...
   // chosePObj.clickContinueButton();
    ...
    //   choosePlanObj.clickContinueButton();
      ...
      cy.wait(1000)
       ...
       ProfileObj.enterlicenseID(faker.number.romanNumeral())
       ProfileObj.selectRandomExperienceOption()
       ProfileObj.selectRandomToolsUsedOptions()
    ...
    cy.wrap(email).as('savedEmail')
      ...
      signupObj.enterPassword(faker.internet.password({ length: 6 }))
       ...
       //validation
         ...
         // Plan selection
    const selectedPlan = 'Inspector';  // Can be changed to any card
